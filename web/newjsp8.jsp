        ...
        <div class="wrapper">
            ...
            <div class="sidebar">
                <ul class="nav nav-pills nav-stacked">
                    <li role="presentation"><a href="http://192.168.206.153:8080/WebApplication2/newjsp4.jsp">数据导入</a></li>
                    <li role="presentation" class="active"><a href="http://192.168.206.153:8080/WebApplication2/newjsp2.jsp">数据查询</a></li>
                    <li role="presentation"><a href="#">数据导出</a></li>
                </ul>
            </div>
            <div class="content">
                ...
                <form name="form1" action="ListAllServlet" method="get">
                    <table border=1>
                        <tr>
                            ...
                            <td>
                                <input type="button" value="saveAs" name="saveAs" onclick="DbExportFileServlet">
