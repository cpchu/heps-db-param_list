...
-- -----------------------------------------------------
-- Table `parameter_list`.`device`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `parameter_list`.`device` ;

CREATE TABLE IF NOT EXISTS `parameter_list`.`device` (
  `Id` INT(11) NOT NULL AUTO_INCREMENT,
  `Name` VARCHAR(45) NULL DEFAULT NULL,
  PRIMARY KEY (`Id`))
ENGINE = InnoDB
...
CREATE TABLE IF NOT EXISTS `parameter_list`.`data` (
  ...
  CONSTRAINT `fk_device_id`
    ...
    REFERENCES `parameter_list`.`device` (`Id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
